      ...
      <div className="layout">
        ...
        <footer>
          ...
          <div id="contributors">
            ...
            <div>
              <figure>
                <div style={{backgroundImage: "url("+ "/images/ben.jpg" + ")"}}></div>
                <figcaption>
                  <h4>Ben Firshman</h4>
                  <p>Product at Docker, creator of Docker&nbsp;Compose.</p>
                  <p>
                    <a href="https://github.com/bfirsh" className="link">GitHub</a>
                    <a href="https://twitter.com/bfirsh" className="link">Twitter</a>
                  </p>
                  </figcaption>
                  </figure>
                  <figure>
                  <div style={{backgroundImage: "url("+ "/images/andreas.jpg" + ")"}}></div>
                  <figcaption>
                  <h4>Andreas Jansson</h4>
                  <p>ML infrastructure lead and researcher at Spotify.</p>
                  <p>
                    <a href="https://github.com/andreasjansson" className="link">GitHub</a>
                  </p>
                  </figcaption>
                  </figure>
            </div>
