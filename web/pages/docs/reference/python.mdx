...
We are working on a new API for reading and analyzing experiment data from Python. It isn't fully documented yet, but <a href="https://colab.research.google.com/drive/14zX3uYaZzHu0Sn7ylQTW1NalM363fcCf" target="_blank">see this notebook for examples of how to use it</a>.
