...
2eeeeee     about a minute ago  stopped  10.1.1.2  andreas  200      4cccccc  5              0.5      N/A
`
...
2eeeeee     about a minute ago  stopped  10.1.1.2  andreas  200      hello    hi       4cccccc  5              0.5      N/A
`
	expected = expected[1:] // strip initial whitespace, added for readability
	actual = trimRightLines(actual)
	require.Equal(t, expected, actual)
