...
func dockerfile() (*asset, error) {
	...
	info := bindataFileInfo{name: "Dockerfile", size: 489, mode: os.FileMode(420), modTime: time.Unix(1595262333, 0)}
...
func baseimagesBaseDockerfile() (*asset, error) {
	...
	info := bindataFileInfo{name: "baseimages-base.Dockerfile", size: 1201, mode: os.FileMode(420), modTime: time.Unix(1595262325, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func baseimagesPackagesDockerfile() (*asset, error) {
	...
	info := bindataFileInfo{name: "baseimages-packages.Dockerfile", size: 57, mode: os.FileMode(420), modTime: time.Unix(1595262325, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
